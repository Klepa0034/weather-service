...
@SpringBootTest
@ActiveProfiles("test")
class DaylightHoursConversionHandlerTest {
    @Autowired
    private DaylightHoursConversionHandler handler;
    ...
    void conversion() {
        ...
        assertThat(weatherReportDto.getGeneralMetrics().getDaylightHours()).isNotNull();
    }
}