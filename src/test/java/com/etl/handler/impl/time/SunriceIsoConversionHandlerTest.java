...
@SpringBootTest
@ActiveProfiles("test")
class SunriceIsoConversionHandlerTest {

    @Autowired
    private SunriseIsoConversionHandler handler;
    ...
    void conversion() {
        ...
        assertThat(weatherReportDto.getGeneralMetrics().getSunriseIsoD()).isNotNull();
    }
}