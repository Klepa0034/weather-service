...
import com.etl.handler.impl.Instant.ShowersInstantConversionHandler;
...
@SpringBootTest
@ActiveProfiles("test")
class ShowersInstantConversionHandlerTest {
    @Autowired
    private ShowersInstantConversionHandler handler;
    ...
    void conversion() {
        ...
        assertThat(weatherReportDto.getGeneralMetrics().getShowerMmPerS()).isNotNull();
    }
}