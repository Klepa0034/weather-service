...
import com.etl.handler.impl.Instant.TemperatureEightyMInstantConversionHandler;
...
@SpringBootTest
@ActiveProfiles("test")
class TemperatureEightyMInstantConversionHandlerTest {
    @Autowired
    private TemperatureEightyMInstantConversionHandler handler;
    ...
    void conversion() {
        ...
        assertThat(weatherReportDto.getGeneralMetrics().getTemperatureEightyMPerS()).isNotNull();
    }
}