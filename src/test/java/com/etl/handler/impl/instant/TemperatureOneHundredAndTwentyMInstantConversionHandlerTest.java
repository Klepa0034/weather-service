...
import com.etl.handler.impl.Instant.TemperatureOneHundredAndTwentyMInstantConversionHandler;
...
@SpringBootTest
@ActiveProfiles("test")
class TemperatureOneHundredAndTwentyMInstantConversionHandlerTest {
    @Autowired
    private TemperatureOneHundredAndTwentyMInstantConversionHandler handler;
    ...
    void conversion() {
        ...
        assertThat(weatherReportDto.getGeneralMetrics().getTemperatureOneHundredAndTwentyPerS()).isNotNull();
    }
}