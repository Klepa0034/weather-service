...
import com.etl.handler.impl.Instant.TemperaturaTwoMInstantConversionHandler;
...
@SpringBootTest
@ActiveProfiles("test")
class TemperaturaTwoMInstantConversionHandlerTest {
    @Autowired
    private TemperaturaTwoMInstantConversionHandler handler;
    ...
    void conversion() {
        ...
        assertThat(weatherReportDto.getGeneralMetrics().getTemperatureTwoMPerS()).isNotNull();
    }
}