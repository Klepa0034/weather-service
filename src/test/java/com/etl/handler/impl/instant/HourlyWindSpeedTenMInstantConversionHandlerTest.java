...
import com.etl.handler.impl.Instant.HourlyWindSpeedTenMInstantConversionHandler;
...
@SpringBootTest
@ActiveProfiles("test")
class HourlyWindSpeedTenMInstantConversionHandlerTest {
    @Autowired
    private HourlyWindSpeedTenMInstantConversionHandler handler;
    ...
    void conversion() {
        ...
        assertThat(weatherReportDto.getGeneralMetrics().getWindSpeedTenMPerS()).isNotNull();
    }
}