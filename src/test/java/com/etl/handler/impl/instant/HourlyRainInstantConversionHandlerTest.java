...
import com.etl.handler.impl.Instant.HourlyRainInstantConversionHandler;
...
@SpringBootTest
@ActiveProfiles("test")
class HourlyRainInstantConversionHandlerTest {
    @Autowired
    private HourlyRainInstantConversionHandler handler;
    ...
    void conversion() {
        ...
        assertThat(weatherReportDto.getGeneralMetrics().getRainMmPerS()).isNotNull();
    }
}