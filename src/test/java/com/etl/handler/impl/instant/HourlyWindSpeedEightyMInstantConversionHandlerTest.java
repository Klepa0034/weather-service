...
import com.etl.handler.impl.Instant.HourlyWindSpeedEightyMInstantConversionHandler;
...
@SpringBootTest
@ActiveProfiles("test")
class HourlyWindSpeedEightyMInstantConversionHandlerTest {
    @Autowired
    private HourlyWindSpeedEightyMInstantConversionHandler handler;
    ...
    void conversion() {
        ...
        assertThat(weatherReportDto.getGeneralMetrics().getWindSpeedEightyMPerS()).isNotNull();
    }
}