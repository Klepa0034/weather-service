...
@SpringBootTest
@ActiveProfiles("test")
class RainDailyLightConversionHandlerTest {
    @Autowired
    private RainDailyLightConversionHandler handler;
    ...
    void conversion() {
        ...
        assertThat(weatherReportDto.getAvgDailyReport().getTotalRainTwentyFourH()).isNotNull();
    }
}