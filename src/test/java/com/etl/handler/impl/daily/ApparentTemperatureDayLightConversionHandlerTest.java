...
@SpringBootTest
@ActiveProfiles("test")
class ApparentTemperatureDayLightConversionHandlerTest {

    @Autowired
    private ApparentTemperatureDayLightConversionHandler handler;
    ...
    void conversion() {
        ...
        assertThat(weatherReportDto.getAvgDailyReport().getAvgApparentTemperatureTwentyFourH()).isNotNull();
    }
}