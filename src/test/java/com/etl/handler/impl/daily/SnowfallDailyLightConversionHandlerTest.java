...
@SpringBootTest
@ActiveProfiles("test")
class SnowfallDailyLightConversionHandlerTest {

    @Autowired
    private SnowfallDailyLightConversionHandler handler;
    ...
    void conversion() {
        ...
        assertThat(weatherReportDto.getAvgDailyReport().getTotalSnowfallTwentyFourH()).isNotNull();
    }
}
