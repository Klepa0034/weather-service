...
@SpringBootTest
@ActiveProfiles("test")
class WindSpeedEightyMDayLightConversionHandlerTest {
    @Autowired
    private WindSpeedEightyMDayLightConversionHandler handler;
    ...
    void conversion() {
        ...
        assertThat(weatherReportDto.getAvgDailyReport().getAvgWindSpeedEightyMTwentyFourH()).isNotNull();
    }
}