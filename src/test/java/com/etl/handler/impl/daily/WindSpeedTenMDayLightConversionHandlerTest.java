...
@SpringBootTest
@ActiveProfiles("test")
class WindSpeedTenMDayLightConversionHandlerTest {

    @Autowired
    private WindSpeedTenMDayLightConversionHandler handler;
    ...
    void conversion() {
        ...
        assertThat(weatherReportDto.getAvgDailyReport().getAvgWindSpeedTenMTwentyFourH()).isNotNull();
    }
}