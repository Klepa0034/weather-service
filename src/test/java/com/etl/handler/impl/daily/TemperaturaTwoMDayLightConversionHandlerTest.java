...
@SpringBootTest
@ActiveProfiles("test")
class TemperaturaTwoMDayLightConversionHandlerTest {

    @Autowired
    private TemperaturaTwoMDayLightConversionHandler handler;
    ...
    void conversion() {
        ...
        assertThat(weatherReportDto.getAvgDailyReport().getAvgTemperatureTwoMTwentyFourH()).isNotNull();
    }
}