...
@SpringBootTest
@ActiveProfiles("test")
class ShowersDailyLightConversionHandlerTest {

    @Autowired
    private ShowersDailyLightConversionHandler handler;
    ...
    void conversion() {
        ...
        assertThat(weatherReportDto.getAvgDailyReport().getTotalShowersTwentyFourH()).isNotNull();
    }
}