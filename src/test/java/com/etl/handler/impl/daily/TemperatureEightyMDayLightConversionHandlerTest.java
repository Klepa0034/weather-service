...
@SpringBootTest
@ActiveProfiles("test")
class TemperatureEightyMDayLightConversionHandlerTest {

    @Autowired
    private TemperatureEightyMDayLightConversionHandler handler;
    ...
    void conversion() {
        ...
        assertThat(weatherReportDto.getAvgDailyReport().getAvgTemperatureEightyMDTwentyFourH()).isNotNull();
    }
}