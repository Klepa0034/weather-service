...
@SpringBootTest
@ActiveProfiles("test")
class TemperatureOneHundredAndTwentyMDayLightConversionHandlerTest {

    @Autowired
    private TemperatureOneHundredAndTwentyMDayLightConversionHandler handler;
    ...
    void conversion() {
        ...
        assertThat(weatherReportDto.getAvgDailyReport().getAvgTemperatureOneHundredAndTwentyMTwentyFourH()).isNotNull();
    }
}