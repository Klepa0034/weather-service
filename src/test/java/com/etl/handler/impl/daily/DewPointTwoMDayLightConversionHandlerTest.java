...
@SpringBootTest
@ActiveProfiles("test")
class DewPointTwoMDayLightConversionHandlerTest {
    @Autowired
    private DewPointTwoMDayLightConversionHandler handler;
    ...
    void conversion() {
        ...
        assertThat(weatherReportDto.getAvgDailyReport().getAvgDewPointTwoMTwentyFourH()).isNotNull();
    }
}