...
@SpringBootTest
@ActiveProfiles("test")
class RelativeHumidityTwoMDayLightConversionHandlerTest {
    @Autowired
    private RelativeHumidityTwoMDayLightConversionHandler handler;
    ...
    void conversion() {
        ...
        assertThat(weatherReportDto.getAvgDailyReport().getAvgRelativeHumidityTwoMDTwentyFourH()).isNotNull();
    }
}