...
@SpringBootTest
@ActiveProfiles("test")
class HourlySnowfallTwentyFourHConversionHandlerTest {
    @Autowired
    private HourlySnowfallTwentyFourHConversionHandler conversionHandler;
    ...
    void conversion() {
        ...
        assertThat(weatherReportDto.getAvgDaylightReport().getSnowfallTwentyFourHDaylight()).isNotNull();
    }
}