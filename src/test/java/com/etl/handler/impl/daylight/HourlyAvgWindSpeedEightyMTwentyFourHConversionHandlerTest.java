...
@SpringBootTest
@ActiveProfiles("test")
class HourlyAvgWindSpeedEightyMTwentyFourHConversionHandlerTest {
    @Autowired
    private HourlyAvgWindSpeedEightyMTwentyFourHConversionHandler handler;
    ...
    void conversion() {
        ...
        assertThat(weatherReportDto.getAvgDaylightReport().getWindSpeedEightyMDaylight()).isNotNull();
    }
}