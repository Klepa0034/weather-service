...
@SpringBootTest
@ActiveProfiles("test")
class HourlyAvgApparentTemperatureTwentyFourHConversionHandlerTest {
    @Autowired
    private HourlyavgApparentTemperatureTwentyFourHConversionHandler handler;
    ...
    void conversion() {
        ...
        assertThat(weatherReportDto.getAvgDaylightReport().getApparentTemperatureDaylight()).isNotNull();
    }
}