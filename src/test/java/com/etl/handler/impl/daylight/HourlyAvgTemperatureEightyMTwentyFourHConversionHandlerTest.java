...
@SpringBootTest
@ActiveProfiles("test")
class HourlyAvgTemperatureEightyMTwentyFourHConversionHandlerTest {
    @Autowired
    private HourlyAvgTemperatureEightyMTwentyFourHConversionHandler handler;
    ...
    void conversion() {
        ...
        assertThat(weatherReportDto.getAvgDaylightReport().getTemperatureEightyMDaylight()).isNotNull();
    }
}