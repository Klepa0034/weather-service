...
@SpringBootTest
@ActiveProfiles("test")
class HourlyAvgWindSpeedTenMTwentyFourHConversionHandlerTest {
    @Autowired
    private HourlyRainTwentyFourHConversionHandler handler;
    ...
    void conversion() {
        ...
        assertThat(weatherReportDto.getAvgDaylightReport().getWindSpeedTenMDaylight()).isNotNull();
    }
}