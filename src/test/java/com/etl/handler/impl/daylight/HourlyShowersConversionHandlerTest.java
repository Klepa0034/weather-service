...
@SpringBootTest
@ActiveProfiles("test")
class HourlyShowersConversionHandlerTest {
    @Autowired
    private HourlyShowersConversionHandler handler;
    ...
    void conversion() {
        ...
        assertThat(weatherReportDto.getAvgDaylightReport().getShowersTwentyFourHDaylight()).isNotNull();
    }
}