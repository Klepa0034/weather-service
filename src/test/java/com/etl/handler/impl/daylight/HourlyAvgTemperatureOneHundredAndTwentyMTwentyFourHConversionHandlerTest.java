...
@SpringBootTest
@ActiveProfiles("test")
class HourlyAvgTemperatureOneHundredAndTwentyMTwentyFourHConversionHandlerTest {
    @Autowired
    private HourlyAvgTemperatureOneHundredAndTwentyMTwentyFourHConversionHandler handler;
    ...
    void conversion() {
        ...
        assertThat(weatherReportDto.getAvgDaylightReport().getTemperatureOneHundredAndTwentyDaylight()).isNotNull();
    }
}