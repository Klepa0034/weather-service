...
@SpringBootTest
@ActiveProfiles("test")
class HourlyAvgDewPointTwoMTwentyFourHConversionHandlerTest {
    @Autowired
    private HourlyAvgDewPointTwoMTwentyFourHConversionHandler handler;
    ...
    void conversion() {
        ...
        assertThat(weatherReportDto.getAvgDaylightReport().getDewPointTwoMDaylight()).isNotNull();
    }
}