...
@SpringBootTest
@ActiveProfiles("test")
class HourlyAvgVisibilityTwentyFourHConversionHandlerTest {
    @Autowired
    private HourlyAvgVisibilityTwentyFourHConversionHandler conversionHandler;
    ...
    void conversion() {
        ...
        conversionHandler.conversion(weatherReportDto, generalWeatherDto);

        assertThat(weatherReportDto.getAvgDaylightReport().getVisibilityDaylight()).isNotNull();
    }
}