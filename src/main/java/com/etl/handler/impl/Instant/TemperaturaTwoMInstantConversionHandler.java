...
/**
 * Handler for processing and converting air temperature data at 2 meters elevation
 * into instantaneous metric values.
 * <p>
 * This component implements the {@link ConversionHandler} interface to calculate and store
 * the average air temperature in Celsius at standard meteorological measurement height
 * (2 meters above ground level). This measurement is fundamental for weather forecasting,
 * climate studies, and human comfort assessments.
 */
@Component
@RequiredArgsConstructor
public class TemperaturaTwoMInstantConversionHandler implements ConversionHandler {
     ...
     * <ol>
     *   <li>Retrieves hourly temperature measurements at 2m height</li>
    ...
    public void conversion(WeatherReportDto weatherReportDto, GeneralWeatherDto generalWeatherDto) {
        ...
        Double average = numericUtils.calculateInCelsius(temperatureTwoM);
        generalMetrics.setTemperatureTwoMPerS(average);
    }
}
