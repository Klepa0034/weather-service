...
/**
 * Handler for processing and converting rainfall data into instantaneous metric values.
 * <p>
 * This component implements the {@link ConversionHandler} interface to calculate and store
 * the average rainfall amount in millimeters (mm). The calculation provides an immediate
 * snapshot of precipitation conditions for operational monitoring and analysis.
 */
@Component
@RequiredArgsConstructor
public class HourlyRainInstantConversionHandler implements ConversionHandler {
    ...
    /**
     * Processes hourly rainfall data and calculates the average rainfall amount.
     * <p>
     * The method performs the following operations:
     * <ol>
     *   <li>Retrieves hourly rainfall measurements in millimeters</li>
     *   <li>Calculates the average rainfall amount</li>
    ...
    public void conversion(WeatherReportDto weatherReportDto, GeneralWeatherDto generalWeatherDto) {
        ...
        double average = numericUtils.calculateValueInMillimeters(rain);
        generalMetrics.setRainMmPerS(average);
    }
}
