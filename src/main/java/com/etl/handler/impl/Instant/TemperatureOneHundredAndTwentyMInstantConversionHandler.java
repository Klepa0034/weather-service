...
/**
 * Handler for processing and converting air temperature data at 120 meters elevation
 * into instantaneous metric values.
 * <p>
 * This component implements the {@link ConversionHandler} interface to calculate and store
 * the average air temperature in Celsius at 120 meters above ground level. This measurement
 * is particularly relevant for modern wind turbine applications, atmospheric research,
 * and tall structure engineering.
 */
@Component
@RequiredArgsConstructor
public class TemperatureOneHundredAndTwentyMInstantConversionHandler implements ConversionHandler {
    ...
    public void conversion(WeatherReportDto weatherReportDto, GeneralWeatherDto generalWeatherDto) {
        ...
        double average = numericUtils.calculateInCelsius(temperatureOneHundredAndTwenty);
        generalMetrics.setTemperatureOneHundredAndTwentyPerS(average);
    }
}
