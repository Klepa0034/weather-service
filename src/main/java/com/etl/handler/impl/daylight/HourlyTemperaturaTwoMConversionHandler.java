 ...
 * the average air temperature in Celsius at standard meteorological height (2m) above ground level,
 * with special emphasis on daylight hours when temperature variations are most significant.
 */
@Component
@RequiredArgsConstructor
public class HourlyTemperaturaTwoMConversionHandler implements ConversionHandler {
    ...
    public void conversion(WeatherReportDto weatherReportDto, GeneralWeatherDto generalWeatherDto) {
        ...
        Double average = numericUtils.calculateAverageInCelsiusDailyLight(temperatureTwoM);
        generalDailyReport.setTemperatureTwoMCelsiusDaylight(average);
    }
}
